...
- **LOADING THIS SKILL IN A CRON RUN — `skill_view` TRUNCATES IT (confirmed 2026-08-18):** SKILL.md is
  ...
  (mirror at `/home/itadmin/jay-skill-pack/skills/automotive/...`) and `read_file(path, offset=35,
  limit=120)` — the "Nightly brain-sync cron normal path" block is around lines 35-77. ALSO:
